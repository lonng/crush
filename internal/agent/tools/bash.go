...
func NewBashTool(permissions permission.Service, workingDir string, attribution *config.Attribution, modelName string) fantasy.AgentTool {
	return NewBashToolWithManager(permissions, workingDir, attribution, modelName, shell.GetBackgroundShellManager())
}

func NewBashToolWithManager(permissions permission.Service, workingDir string, attribution *config.Attribution, modelName string, bgManager *shell.BackgroundShellManager) fantasy.AgentTool {
	if bgManager == nil {
